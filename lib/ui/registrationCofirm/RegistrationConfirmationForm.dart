    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
            ...
            onPressed: () {
              var emailText = emailTextController.text.toString();
              var mobileNumber = mobileNumberTextController.text.toString();
              var deviceImeiTextController_ =
                  deviceImeiTextController.text.toString();
              var invoiceAmountTextController_ =
                  invoiceAmountTextController.text.toString();
              var invoiceDateTextController_ =
                  invoiceDateTextController.text.toString();
              var nationalIDtextController_ =
                  nationalIDtextController.text.toString();
              var mFathereNametextController_ =
                  mFathereNametextController.text.toString();
              print("firstName === $firstName");
              print("lastName === $lastName");
              print("emailText === $emailText");
              print("mobileNumber === $mobileNumber");
              print("deviceImeiTextController_ === $deviceImeiTextController_");
              print(
                  "invoiceAmountTextController_ === $invoiceAmountTextController_");
              print(
                  "invoiceDateTextController_ === $invoiceDateTextController_");

              Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(
                    builder: (context) => EditRegistrationProcess(
                        firstName,
                        lastName,
                        emailTextController.text.toString(),
                        mobileNumberTextController.text.toString(),
                        deviceImeiTextController.text.toString(),
                        invoiceAmountTextController.text.toString(),
                        invoiceDateTextController.text.toString(),
                        nationalIDtextController_,
                        mFathereNametextController_),
                  ));
            }),
//              onPressed: () => ),
        title: Text(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    labelText: 'Invoice Amount' +
                        '(' +
                        PreferenceUtils.getString(Utils.CURRENCYFORPREFRENCE) +
                        ')',
                    labelStyle:
                        TextStyle(color: Colors.blue, fontFamily: 'OpenSans'),
                    contentPadding: EdgeInsets.all(5),
            ...
            Visibility(
              ...
              child: TextFormField(
                ...
                validator: (value) {
                  ...
                  if (value.length <= 2) {
                    return 'Father name should be atleast 3 characters';
                  }
                  return null;
                },
                onSaved: (String value) {
