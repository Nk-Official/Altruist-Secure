...
class RepairNowScreen extends StatefulWidget {
  @override
  RepairNowScreenState_ createState() => RepairNowScreenState_();
}

class RepairNowScreenState_ extends State<RepairNowScreen> {
            ...
            new Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text(
                    "Dear Customer, \n\nBased on the diagnosis of your device, approx repair value will be ..... \n\nPlease click OK to confirm ",
                  ...
                  Visibility(
                    ...
                    child:
                    Text(
                      "Thanks for showing your interest. We will pick up the device for repair from your door step. Our executive will call you soon to assist you further",
                      textAlign: TextAlign.start,
                      style: TextStyle(
                        fontSize: 15,
                        color: Colors.black87,
