...
public class DisplayTestScreenActivity extends Activity implements View.OnClickListener, SeekBar.OnSeekBarChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //alertDialog = new AlertDialog.Builder(DisplayTestScreenActivity.this).create();
       // mpopup();
    }
